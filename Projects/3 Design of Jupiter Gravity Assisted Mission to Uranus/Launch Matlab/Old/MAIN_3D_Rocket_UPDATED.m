...
mfuel = 59090; % Mass of fuel for Atlas V (variable)

mf = 21054; % Dry mass of AtlasV (fixed) [kg]
mpayload = 11874.28; % SEC-III+fuel for mission+scientific payload [kg] (fixed)
m_wet    = mf+mfuel+mpayload;  %[kg]
m_dry    = mf+mpayload;   %[kg]     Dry mass
d        = 3.8E-3;    %[km]     Rocket diameter
T        = 3989.5;    %[kN] Avg between Sea-level+Vaccum thrust
Isp      = 324.55;   %[s]   "                          " Specific impulse

% Launch Parameters
Az_po    = 108.2;     %[deg]    Azimuth at pitchover (inertial)
gam_po   = 89.85 ;    %[deg]    FPA at pitchover
z_po     = 0.353;     %[km]    Altitude at pitchover

% Launch Window Data
D_Lam    = 133.61/180*pi; 
d_vinf   = -5.991/180*pi; % Declination of v_inf
...
t_Coast  = 228;     %[s]      Coasting time after b/o

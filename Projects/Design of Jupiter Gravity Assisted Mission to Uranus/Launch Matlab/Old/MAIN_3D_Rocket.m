...
m_wet    = 340000;  %[kg]     Wet mass
m_dry    = 18060;   %[kg]     Dry mass
d        = 5E-3;    %[km]     Rocket diameter
T        = 4000;    %[kN]     Thrust
...
z_po     = 0.323;     %[km]    Altitude at pitchover
...
z_LS     =      3;  %[m]      Launch site altitude 

t_Coast  = 3000;     %[s]      Coasting time after b/o
z_park   = 300;     %[km]     Parking orbit altitude 

R_Planet  = 227.9E6; %[km]  Radius of target planet's orbit

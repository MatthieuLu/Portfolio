...
%% Options
function  earth_plot(Omega,RE,r_I)
...
erad    = RE; % equatorial radius (meters)
prad    = RE; % polar radius (meters)
erot    = Omega; % earth rotation rate (radians/sec)
...
plot3(r_I(1,:),r_I(2,:),r_I(3,:),'linewidth',2.0,'color','y')

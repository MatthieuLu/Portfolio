...
if strcmp(Planet_1,'Mars')
    h_flyby =  5000;
end
if strcmp(Planet_1,'Jupiter')
    h_flyby = 842000;
end
if strcmp(Planet_1,'Saturn')
    h_flyby = 630000;
end
if strcmp(Planet_1,'Uranus')
    h_flyby = 240000;
end
if strcmp(Planet_1,'Neptune')
    h_flyby = 300000;
end

% (5) Set periapsis and apoapsis radius for target orbit around Planet_2
if strcmp(Planet_2,'Jupiter')
    rp_targ = 120000;
    ra_targ = 9000000;
end
if strcmp(Planet_2,'Saturn')
    rp_targ = 630000;
    ra_targ = 3*rp_targ;
end
